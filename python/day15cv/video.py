...
class Book(VideoSynthBase):
    def __init__(self, **kw):
        ...
        backGr = cv.imread(cv.samples.findFile('data/graf1.png'))
        fgr = cv.imread(cv.samples.findFile('data/box.png'))
...
class Cube(VideoSynthBase):
    def __init__(self, **kw):
        ...
        self.render = TestSceneRender(cv.imread(cv.samples.findFile('data/pca_test1.jpg')), deformation = True,  speed = 1)
